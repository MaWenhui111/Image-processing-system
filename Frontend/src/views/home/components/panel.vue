<template>
  <div class="main">
    <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      <el-tab-pane label="几何变换" name="basic" class="el-tabs__content">
      ...
      <el-tab-pane label="剪裁与灰度化" name="cropandgray" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            <el-divider content-position="center" style="font-size: 20px">随机剪裁</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">宽度</span>
              <el-input oninput="if(value>1000)value=1000;if(value<0)value=0" v-model="w" placeholder="输入值，例如：100"
                style="margin-left: 10px; width: 200px" />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">高度</span>
              <el-input oninput="if(value>1000)value=1000;if(value<0)value=0" v-model="h" placeholder="输入值，例如：200"
                style="margin-left: 10px; width: 200px" />
            </div>
            <el-button @click="cropHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <el-divider content-position="center" style="font-size: 20px">灰度化</el-divider>
            <el-button @click="grayHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="噪声添加" name="noise" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            ...
            <el-divider content-position="center" style="font-size: 20px">均匀随机噪声</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">均值</span>
              <el-input oninput="if(value>10)value=10;if(value<0)value=0" v-model="inputMean2" placeholder="输入值，例如：1"
                style="margin-left: 10px; width: 200px" />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">方差</span>
              <el-input oninput="if(value>100)value=100;if(value<0)value=0" v-model="inputVariance2" placeholder="输入值，例如：0.02"
                style="margin-left: 10px; width: 200px" />
            </div>
            <el-button @click="addrandom_meanHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="图像平滑" name="blur" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            <el-divider content-position="center" style="font-size: 20px">线性滤波
            </el-divider>
            <div style="margin-bottom: 15px">
              <div>
                <el-radio v-model="ValueOfMeanOrGaussian" label="mean" size="large" border>均值滤波</el-radio>
                <el-radio v-model="ValueOfMeanOrGaussian" label="median" size="large" border>高斯滤波</el-radio>
              </div>
            </div>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">滤波核大小</span>
              <el-input oninput="if(value>10)value=10;if(value<0)value=0" v-model="inputMeanOrGaussianSize"
                placeholder="输入值，例如：3或5或7" style="margin-left: 10px; width: 200px" />
            </div>
            ...
            <el-divider content-position="center" style="font-size: 20px">非线性滤波</el-divider>
            <div>
                  <el-tag style="margin-bottom: 8px; align-items: center; font-size: 15px">中值滤波</el-tag>
            </div>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">滤波核大小</span>
              <el-input oninput="if(value>10)value=10;if(value<0)value=0" v-model="inputMedianSize"
                placeholder="输入值，例如：3或5或7" style="margin-left: 10px; width: 200px" />
            </div>
            <el-button @click="MedianblurHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <div>
                  <el-tag style="margin-bottom: 8px; align-items: center; font-size: 15px">双边滤波</el-tag>
            </div>
            <el-button @click="bilateralblurHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="边缘检测" name="space" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            <el-divider content-position="center" style="font-size: 20px">灰度化</el-divider>
            <el-button @click="grayHandler" type="primary"
            ...
            <el-divider content-position="center" style="font-size: 20px">边缘锐化</el-divider>
            <div>
            ...
            <div>
                  <el-tag style="margin-bottom: 8px; align-items: center; font-size: 15px">一阶算子</el-tag>
            </div>
            <div style="margin-bottom: 15px">
              <div>
                <el-radio v-model="ValueOfEdgeone" label="Roberts" size="large" border>Roberts</el-radio>
                <el-radio v-model="ValueOfEdgeone" label="Prewitt" size="large" border>Prewitt</el-radio>
              </div>
            </div>
            <el-button @click="edge1Handler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <div>
                  <el-tag style="margin-bottom: 8px; margin-top: 15px; align-items: center; font-size: 15px">二阶算子</el-tag>
            </div>
            <div style="margin-bottom: 15px">
              <div>
            ...
            <div class="slider-demo-block">
              ...
              <el-input oninput="if(value>255)value=255;if(value<0)value=0" v-model="inputEdgeThreshold" placeholder="输入值，例如：5"
                style="margin-left: 10px; width: 200px" />
            </div>
            <el-button @click="edge2Handler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="图像分割" name="partitionPart" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            ...
            <div style="margin-bottom: 15px">
              <div>
                <el-radio v-model="ValueOfgudingOradaptive" label="guding" size="large" border>固定阈值分割</el-radio>
                <el-radio v-model="ValueOfgudingOradaptive" label="adaptivemean" size="large" border>自适应阈值分割</el-radio>
                <el-radio v-model="ValueOfgudingOradaptive" label="adaptivegaussian" size="large" border>自适应阈值分割</el-radio>
              </div>
            </div>
            <el-button @click="gudingOradaptiveHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <el-button @click="colorSegHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="彩图处理" name="colorful" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            ...
            <el-divider content-position="center" style="font-size: 20px">图像增强</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration">亮度</span>
              <el-slider v-model="brightness" :step="1" :min="-255" :max="255" show-input />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration">对比度</span>
              <el-slider v-model="contrast" :step="0.1" :min="0.1" :max="5" show-input />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration">饱和度 </span>
              <el-slider v-model="saturation" :step="0.1" :min="0.1" :max="5" show-input />
            </div>
            <el-button @click="bcsadjustHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <el-divider content-position="center" style="font-size: 20px">HSV调整</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration">H</span>
              <el-slider v-model="hue" :step="1" :min="0" :max="360" show-input />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration">S</span>
              <el-slider v-model="s" :step="1" :min="0" :max="100" show-input />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration">V</span>
              <el-slider v-model="v" :step="1" :min="0" :max="100" show-input />
            </div>
            <el-button @click="hsvadjustHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="特殊处理" name="special" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            <el-divider content-position="center" style="font-size: 20px">加边框</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration">边框大小</span>
              <el-slider v-model="fillsize" :step="1" :min="1" :max="100" show-input />
            </div>
            <div class="slider-demo-block">
              <span class="demonstration" style="margin-right: 4px; overflow: visible">颜色</span>
              <el-slider v-model="fillcolor" :step="1" :min="0" :max="100" show-input />
            </div>
            <el-button @click="addBorderHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
            ...
            <el-divider content-position="center" style="font-size: 20px">图像雾化</el-divider>
            <div class="slider-demo-block">
              <span class="demonstration">雾化程度(%)</span>
              <el-slider v-model="t" :step="1" :min="10" :max="100" show-input />
            </div>
            <el-button @click="HazeHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
      ...
      <el-tab-pane label="特征描述" name="featuredescription" class="el-tabs__content">
        <el-scrollbar noresize height="560px">
          <div style="width: 98%">
            <el-divider content-position="center" style="font-size: 20px">轮廓绘制</el-divider>
            <el-button @click="FeaturedesHandler" type="primary"
              style="margin-top: 6px; margin-left: 4px; align-items: center">
              <el-icon size="medium">
                <Setting />
              </el-icon>
...
export default {
  ...
  data() {
    return {
      ...
      //图像平滑（线性滤波），滤波核大小
      ValueOfMeanOrGaussian: "mean",
      inputMeanOrGaussianSize: '',

      //图像平滑（非线性中值滤波）,滤波核大小
      inputMedianSize: '',

      //双边滤波，无参数
      bilateralblurValue: 'bilateral_blur',

      //阈值分割
      ValueOfgudingOradaptive: 'guding',

      //彩色分割，无参数
      inputcolorseg:'inputcolorseg',
  ...
  methods: {
    ...
    async addrandom_meanHandler() {
      ...
      //以上为必备操作
      //针对不同操作调用不同API即可
      let res = await API.addrandom_mean({
        inputMean2: this.inputMean2,
        inputVariance2: this.inputVariance2,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
    ...
    async filterHandler() {
      ...
      let res = await API.filter({
        ValueOfMeanOrGaussian: this.ValueOfMeanOrGaussian,
        inputMeanOrGaussianSize: this.inputMeanOrGaussianSize,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
    ...
    async MedianblurHandler() {
      ...
      //针对不同操作调用不同API即可
      let res = await API.Medianblur({
        inputMedianSize: this.inputMedianSize,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
    ...
    async bilateralblurHandler() {
      ...
      //针对不同操作调用不同API即可
      let res = await API.bilateralblur({
        bilateralblurValue: this.bilateralblurValue,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
    ...
    async edge1Handler() {
      ...
      //以上为必备操作
      //针对不同操作调用不同API即可
      let res = await API.edge1({
        ValueOfEdge: this.ValueOfEdgeone,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
    ...
    async colorSegHandler() {
      ...
      //以上为必备操作
      //针对不同操作调用不同API即可
      let res = await API.colorSeg({
        inputcolorseg: this.inputcolorseg,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
      ...
      ElNotification({
        title: "操作成功",
        message: "图片已进行HSV体系分割",
        type: "success",
      });
    },


    async gudingOradaptiveHandler() {
      let loading = ElLoading.service({
        lock: true,
        text: "处理中...",
        background: "rgba(255, 255, 255, 0.2)",
      ...
      //以上为必备操作
      //针对不同操作调用不同API即可
      let res = await API.Seg({
        ValueOfgudingOradaptive: this.ValueOfgudingOradaptive,
        id: _id,
      });
      //以下为必备操作
      this.$store.commit("image/SET_URL", res.data.file);
