...
首先非常感谢大佬的开源代码：
<https://github.com/Nomination-NRB/ImageProcess>
...
①　图像的几何变换部分旋转结果展示
![1](img/%E5%9B%BE%E7%89%871.png)
②　图像的剪裁结果展示
![2](img/%E5%9B%BE%E7%89%872.png)
③　图像的灰度变换部分灰度化后进行直方图均衡化结果展示
![3](img/%E5%9B%BE%E7%89%873.png)
④　图像的噪声添加部分高斯噪声添加结果展示
![4](img/%E5%9B%BE%E7%89%875.png)
⑤　图像平滑部分对刚才添加噪声的图像进行高斯去噪结果展示
![4](img/%E5%9B%BE%E7%89%876.png)
⑥　对图像灰度化处理后进行Sobel算子边缘检测结果展示
![4](img/%E5%9B%BE%E7%89%877.png)
⑦　图像分割部分进行自适应阈值分割结果展示
![4](img/%E5%9B%BE%E7%89%878.png)
